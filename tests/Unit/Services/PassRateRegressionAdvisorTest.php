...
final class PassRateRegressionAdvisorTest extends TestCase
{
    ...
    public function regressionWhenDeltaExceedsThresholdAndBaselineAboveSeventy(): void
    {
        ...
        // Baseline 91%, current 73%, delta -18pp, 40 reports — clears every floor.
        $window7d = new PassRateAggregate(passRate: 73.0, reportCount: 40, totalMessages: 1000, failingMessages: 270);
    ...
    public function regressionFiresExactlyAtTenPpDrop(): void
    {
        ...
        // silently flip the comparator.
        $advisor = new PassRateRegressionAdvisor();
        $window7d = new PassRateAggregate(passRate: 80.0, reportCount: 25, totalMessages: 500, failingMessages: 100);
        $baseline30d = new PassRateAggregate(passRate: 90.0, reportCount: 50, totalMessages: 2000, failingMessages: 200);
    ...
    {
        // 9.9pp drop — one tenth below the regression floor.
        $advisor = new PassRateRegressionAdvisor();
        $window7d = new PassRateAggregate(passRate: 80.1, reportCount: 25, totalMessages: 500, failingMessages: 100);
        $baseline30d = new PassRateAggregate(passRate: 90.0, reportCount: 50, totalMessages: 2000, failingMessages: 200);
    ...
    public function stableWhenBaselineAlreadyBroken(): void
    {
        ...
        // noise without adding value. Stable.
        $advisor = new PassRateRegressionAdvisor();
        $window7d = new PassRateAggregate(passRate: 40.0, reportCount: 30, totalMessages: 500, failingMessages: 300);
    ...
    public function percentFromTopSenderHandlesZeroFailingMessages(): void
    {
        ...
        $advisor = new PassRateRegressionAdvisor();
        $window7d = new PassRateAggregate(passRate: 80.0, reportCount: 25, totalMessages: 500, failingMessages: 0);
        $baseline30d = new PassRateAggregate(passRate: 95.0, reportCount: 50, totalMessages: 2000, failingMessages: 100);
    ...
    public function percentFromTopSenderHandlesNullSender(): void
    {
        ...
        // the banner skips the "Investigate this sender" link.
        $advisor = new PassRateRegressionAdvisor();
        $window7d = new PassRateAggregate(passRate: 80.0, reportCount: 25, totalMessages: 500, failingMessages: 100);
        $baseline30d = new PassRateAggregate(passRate: 95.0, reportCount: 50, totalMessages: 2000, failingMessages: 100);
