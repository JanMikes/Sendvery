...
final class AuthorizeSenderController extends AbstractController
{
    ...
    #[Route('/app/domains/{domainId}/senders/{senderId}/authorize', name: 'dashboard_sender_authorize', methods: ['POST'])]
    public function __invoke(string $domainId, string $senderId, Request $request): Response
    {
        ...
        $this->addFlash('success', 'Sender authorized.');
