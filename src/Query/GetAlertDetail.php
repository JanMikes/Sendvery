...
final readonly class GetAlertDetail
{
    ...
    public function forAlert(string $alertId, array $teamIds): ?AlertDetailResult
    {
        ...
        /** @var array{alert_id: string, type: string, severity: string, title: string, message: string, data: string, is_read: bool|string, created_at: string, snoozed_until: string|null, resolved_at: string|null, domain_id: string|null, domain_name: string|null}|false $row */
